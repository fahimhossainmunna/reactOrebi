        ...
        <div className="">
            ...
            <div className="flex flex-wrap justify-start gap-x-[60px]">
                <div className="w-[508px]">
                    ...
                    <input type="text" placeholder='First Name' className='text=[14px] text-[#767676] font-sans ' />
                ...
                <div className="w-[508px]">
                    ...
                    <input type="text" placeholder='Last Name' className='text=[14px] text-[#767676] font-sans ' />
                <div className="mt-[15px] border-b border-b-[#D8D8D8] w-[507px]"></div>
                </div>
                </div>
            </div>
            <div className="flex flex-wrap justify-start gap-x-[60px]">
                <div className="w-[508px]">
                    ...
                    <input type="email" placeholder='company@domain.com' className='text=[14px] text-[#767676] font-sans w-[300px]' />
                <div className="mt-[15px] border-b border-b-[#D8D8D8] w-[507px]"></div>
                </div>
                <div className="w-[508px]">
                    <div className="w-[508px]">
                    <h3 className='text=[16px] text-[#262626] font-bold font-sans leading-[24px] mt-[42px] mb-[10px]'>Telephone</h3>
                    <input type="number" placeholder='Your phone number' className='text=[14px] text-[#767676] font-sans  ' />
                <div className="mt-[15px] border-b border-b-[#D8D8D8] w-[507px]"></div>
                </div>
                </div>
            </div>
